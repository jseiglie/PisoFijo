...
const getState = ({ getStore, getActions, setStore }) => {
  return {
    store: {
      baseUrlRegister:
        "https://3001-programisto1011-4geekaca-8affixwmdig.ws-eu38.gitpod.io/api/register",
		  baseUrlLogin:
        "https://3001-programisto1011-4geekaca-8affixwmdig.ws-eu38.gitpod.io/api/login",
      token: null,
